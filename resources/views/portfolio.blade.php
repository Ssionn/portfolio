        ...
        <main class="flex flex-col items-center space-y-16">
            ...
            <div class="container mx-auto max-w-6xl p-4 sm:p-6 lg:p-8 mt-20">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <a href="https://github.com/Ssionn/dotfiles" target="_blank" class="flex flex-col bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105 opacity-0 translate-y-4 transition-all duration-700 ease-out h-full" data-project-card>
                        <img class="object-cover w-full h-48 rounded-t-lg" src="{{ asset('storage/images/projects/dotfiles.png') }}" alt="Dotfiles Project">
                        <div class="flex flex-col justify-between p-4 flex-grow">
                            <div>
                                <h3 class="mb-2 text-2xl font-bold tracking-tight text-gray-900">Ssionn/dotfiles</h3>
                                <p class="mb-3 font-normal text-gray-700">Neovim configuration and plugins.</p>
                            </div>
                            <div class="flex flex-wrap items-center text-sm text-gray-500 gap-4 mt-auto pt-4 border-t border-gray-200">
                                <span class="flex items-center">
                                    ...
                                    <span class="pt-1">1 Contributor</span>
                                </span>
                                <span class="flex items-center">
                                    ...
                                    <span class="pt-1">17 Commits</span>
                                </span>
                                <span class="flex items-center">
                                ...
                                <span class="flex items-center">
                                    ...
                                    <span class="pt-1">0 Forks</span>
                                </span>
                            </div>
                        </div>
                    </a>

                    <a href="#" class="flex flex-col bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105 opacity-0 translate-y-4 transition-all duration-700 ease-out h-full" data-project-card>
                        <img class="object-cover w-full h-48 rounded-t-lg" src="{{ asset('storage/images/projects/programming-blog.png') }}" alt="Project 2">
                        <div class="flex flex-col justify-between p-4 flex-grow">
                            <div>
                                <h3 class="mb-2 text-2xl font-bold tracking-tight text-gray-900">Ssionn/programming-blog</h3>
                                <p class="mb-3 font-normal text-gray-700">A random blog/project that came to me using OAuth, easy authentication and a finite amount of javascript.</p>
                            </div>
                            <div class="flex flex-wrap items-center text-sm text-gray-500 gap-4 mt-auto pt-4 border-t border-gray-200">
                                <span class="flex items-center">
                                    <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M9 6a3 3 0 11-6 0 3 3 0 016 0zM17 6a3 3 0 11-6 0 3 3 0 016 0zM12.93 17c.046-.327.07-.66.07-1a6.97 6.97 0 00-1.5-4.33A5 5 0 0119 16v1h-6.07zM6 11a5 5 0 015 5v1H1v-1a5 5 0 015-5z"></path></svg>
                                ...
                                <span class="flex items-center">
                                    <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clip-rule="evenodd"></path></svg>
                                    <span class="pt-1">35 Commits</span>
                                </span>
                                <span class="flex items-center">
                                    <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-11a1 1 0 10-2 0v2H7a1 1 0 100 2h2v2a1 1 0 102 0v-2h2a1 1 0 100-2h-2V7z" clip-rule="evenodd"></path></svg>
                                    <span class="pt-1">2 Stars</span>
                                </span>
                                <span class="flex items-center">
                                    <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-8.707l-3-3a1 1 0 00-1.414 0l-3 3a1 1 0 001.414 1.414L9 9.414V13a1 1 0 102 0V9.414l1.293 1.293a1 1 0 001.414-1.414z" clip-rule="evenodd"></path></svg>
                                    <span class="pt-1">0 Forks</span>
                    ...
                    <a href="#" class="flex flex-col bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105 opacity-0 translate-y-4 transition-all duration-700 ease-out h-full" data-project-card>
                        <img class="object-cover w-full h-48 rounded-t-lg" src="{{ asset('storage/images/projects/todo-app.png') }}" alt="Project 3">
                        <div class="flex flex-col justify-between p-4 flex-grow">
                            <div>
                                <h3 class="mb-2 text-2xl font-bold tracking-tight text-gray-900">Ssionn/todo-app</h3>
                                <p class="mb-3 font-normal text-gray-700">Simple todo app, nothing fancy.</p>
                            </div>
                            <div class="flex flex-wrap items-center text-sm text-gray-500 gap-4 mt-auto pt-4 border-t border-gray-200">
                                <span class="flex items-center">
                                    <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M9 6a3 3 0 11-6 0 3 3 0 016 0zM17 6a3 3 0 11-6 0 3 3 0 016 0zM12.93 17c.046-.327.07-.66.07-1a6.97 6.97 0 00-1.5-4.33A5 5 0 0119 16v1h-6.07zM6 11a5 5 0 015 5v1H1v-1a5 5 0 015-5z"></path></svg>
                                ...
                                <span class="flex items-center">
                                    <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clip-rule="evenodd"></path></svg>
                                    <span class="pt-1">1 Commits</span>
                                </span>
                                <span class="flex items-center">
                                    <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-11a1 1 0 10-2 0v2H7a1 1 0 100 2h2v2a1 1 0 102 0v-2h2a1 1 0 100-2h-2V7z" clip-rule="evenodd"></path></svg>
                                    <span class="pt-1">0 Stars</span>
                                </span>
                                <span class="flex items-center">
                                    <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-8.707l-3-3a1 1 0 00-1.414 0l-3 3a1 1 0 001.414 1.414L9 9.414V13a1 1 0 102 0V9.414l1.293 1.293a1 1 0 001.414-1.414z" clip-rule="evenodd"></path></svg>
                                    <span class="pt-1">0 Forks</span>
                    ...
                    <a href="#" class="flex flex-col bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105 opacity-0 translate-y-4 transition-all duration-700 ease-out h-full" data-project-card>
                        <img class="object-cover w-full h-48 rounded-t-lg" src="{{ asset('storage/images/projects/github-data-dashboard.png') }}" alt="Project 3">
                        <div class="flex flex-col justify-between p-4 flex-grow">
                            <div>
                                <h3 class="mb-2 text-2xl font-bold tracking-tight text-gray-900">Ssionn/github-data-dashboard</h3>
                                <p class="mb-3 font-normal text-gray-700">Random project I still need to finish.</p>
                            </div>
                            <div class="flex flex-wrap items-center text-sm text-gray-500 gap-4 mt-auto pt-4 border-t border-gray-200">
                                <span class="flex items-center">
                                    <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M9 6a3 3 0 11-6 0 3 3 0 016 0zM17 6a3 3 0 11-6 0 3 3 0 016 0zM12.93 17c.046-.327.07-.66.07-1a6.97 6.97 0 00-1.5-4.33A5 5 0 0119 16v1h-6.07zM6 11a5 5 0 015 5v1H1v-1a5 5 0 015-5z"></path></svg>
                                ...
                                <span class="flex items-center">
                                    <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clip-rule="evenodd"></path></svg>
                                    <span class="pt-1">10 Commits</span>
                                </span>
                                <span class="flex items-center">
                                    <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-11a1 1 0 10-2 0v2H7a1 1 0 100 2h2v2a1 1 0 102 0v-2h2a1 1 0 100-2h-2V7z" clip-rule="evenodd"></path></svg>
                                    <span class="pt-1">1 Stars</span>
